      ...
      <header class="header min-height">
        <div class="container" style="padding-left: 0px ">
          ...
          <div class="is-navbar-container">
            <div class="is-brand">
                <img src="assets/img/navbar-logo.png" class="is-logo" alt="Logo of the 4+Architects group.">              
                <!-- nav toggle element -->
                <a href="#"
            ...
            <div id="navbar" class="is-navbar is-hidden-mobile">
                <nav class="is-push-right">
                    <ul>
                        <li>
                          <a href="#" class="navbar-link">Пројекти</a>
                        </li>
                        <li>
                          <a href="#" class="navbar-link">Студио 4+</a>
                        </li>
                        <li>
                          <a href="#" class="navbar-link">Инфо</a>
                        </li>
                        <li>
                          <a href="#" class="navbar-link">Контакт</a>
                        </li>
                    </ul>
                </nav>
            </div>
